...
from ..trader_tool import demjson
class dfcf_bond_cov_data:
    def __init__(self):
        '''
        东方财富可转债数据
        '''
    def _code_id_map(self) -> dict:
        """
        东方财富-股票和市场代码
    ...
    def bond_zh_hs_cov_pre_min(self,symbol: str = "sh113570") -> pd.DataFrame:
        """
        东方财富网-可转债-分时行情-盘前
        https://quote.eastmoney.com/concept/sz128039.html
        :param symbol: 转债代码
    ...
    def bond_zh_cov(self) -> pd.DataFrame:
        """
    ...
    def bond_cov_comparison(self) -> pd.DataFrame:
        """
    ...
    def bond_zh_cov_info(self,symbol: str = "123121", indicator: str = "基本信息") -> pd.DataFrame:
        """
    ...
    def bond_zh_cov_value_analysis(self,symbol: str = "123138") -> pd.DataFrame:
        """
...
if __name__ == "__main__":
    ...
    bond_zh_hs_cov_pre_min_df = models.bond_zh_hs_cov_pre_min(symbol="sz128039")
    print(bond_zh_hs_cov_pre_min_df)

    bond_zh_hs_cov_daily_df = models.bond_zh_hs_cov_daily(symbol="sz128039")
    print(bond_zh_hs_cov_daily_df)

    bond_zh_hs_cov_spot_df = models.bond_zh_hs_cov_spot()
    print(bond_zh_hs_cov_spot_df)

    bond_zh_cov_df = models.bond_zh_cov()
    print(bond_zh_cov_df)

    bond_cov_comparison_df = models.bond_cov_comparison()
    print(bond_cov_comparison_df)

    bond_zh_cov_info_df = models.bond_zh_cov_info(symbol="123121", indicator="基本信息")
    print(bond_zh_cov_info_df)

    bond_zh_cov_value_analysis_df = models.bond_zh_cov_value_analysis(symbol="113527")
